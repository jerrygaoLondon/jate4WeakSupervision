 ...
 * This class
 */
public class CorpusParser extends ACLRDTECTest {
    ...
    private static JATEDocument loadJATEDocFromACL2XML(InputStream fileInputStream) throws JATEException {
        ...
        try {
            ...
            normalizedText = unescapeHtml(unescapeHtml(normalizedText));
    ...
    public static void main(String[] args) {
        CorpusParser jse = new CorpusParser();
        try {
            jse.exportACLCorpus(Paths.get("c:", "Data", "jate", "jate4supervision", "ACLRDTEC-1"), CorpusParser.ACL_RDTEC_VERSION_1);
//            jse.exportACLCorpus(Paths.get("c:", "Data", "jate", "jate4supervision", "ACLRDTEC-2"), CorpusParser.ACL_RDTEC_VERSION_2);
